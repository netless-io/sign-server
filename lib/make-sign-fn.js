...
export default function makeSignFn(
  ...
  return async function sign({ file, hash, isNest }, res) {
    ...
    if (typeof file === "object") {
      ...
      console.log("Signing (new)", file.name, file_hash);
    ...
    if (typeof file === "string") {
      ...
      console.log("Signing (cached)", file_hash);
    ...
    console.log("Signed", new_file_hash);
    meta = cache.meta(); // make sure we do not miss any meta file changes during the signing
